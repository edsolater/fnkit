import { CollectionItems } from "../collectionMethods"
...
export type Keyof<O> = O extends CollectionItems<infer K> ? K : unknown
export type Valueof<O> = O extends CollectionItems<infer V> ? V : unknown
/**
 * extract only string
 */
