...
export function asyncPipe<T, R, M1>(
  v: MayPromise<T>,
  ...fns: [(v: T) => MayPromise<M1>, (v: M1) => MayPromise<R>]
): Promise<R>
export function asyncPipe<T, R>(v: MayPromise<T>, ...fns: [(v: T) => MayPromise<R>]): Promise<R>
export function asyncPipe<T>(v: MayPromise<T>, ...fns: ((v: T) => MayPromise<T>)[]): Promise<T>
export function asyncPipe<T>(v: MayPromise<T>, ...fns: ((v: T) => MayPromise<T>)[]): Promise<T> {
