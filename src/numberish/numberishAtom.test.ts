import { toFraction, toFractionFromString, toStringNumber } from "./numberishAtom"
...
test("numberish: toString 2", () => {
  expect(toFractionFromString("-7.613920682825182e-8")).toEqual({
    decimal: 23,
    numerator: -7613920682825182n,
    denominator: 1n,
  })
  expect(toFractionFromString("3e2")).toEqual({
    decimal: -2,
    numerator: 3n,
    denominator: 1n,
  })
  expect(toStringNumber(toFractionFromString("3e-2"))).toEqual("0.03")
  expect(toStringNumber(toFractionFromString("3e2"))).toEqual("300")
  expect(toStringNumber(toFractionFromString("3.44e2"))).toEqual("344")
