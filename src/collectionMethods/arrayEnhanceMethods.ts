 ...
 */
export function omit<T extends Collection, U extends keyof T>(collection: T, propNameList: MayArray<U>): Omit<T, U> {
  return filter(collection, (_value, key) => !flap(propNameList).includes(key as any)) as unknown as Omit<T, U>
}
